          ...
          <div className="checkout">
              <div className="checkout-info">
                  ...
                  <form action="" className="form-info checkout-item">
                      <div className="form-control form-item">
                          <input placeholder="Họ và tên" id="fullname" type="text" />
                          <small></small>
                      </div>
                      <div className="form-inline_1 form-item">
                          <div className="form-control w-2">
                              <input placeholder="Email" id="email" type="text" />
                              <small></small>
                          </div>
                          <div className="form-control w-1">
