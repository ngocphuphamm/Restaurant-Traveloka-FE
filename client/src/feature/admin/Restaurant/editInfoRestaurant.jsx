...
export default function EditInfoRestaurant({infoRestaurant})
{
    ...
    const handleChangeEditRestaurant = (e) => {
      ...
      const handleEditInfoRestaurant = async () =>{
          try{
              const {data} = await axios.post(`${process.env.REACT_APP_API_URL}/admin/restaurant/editRestaurant/${infoRestaurant.idRestaurant}`,editRestaurant);
...
<div className="userUpdate">
              ...
              <form className="userUpdateForm">
                <div className="userUpdateLeft">
                  ...
                  <button className="userUpdateButton mt-5" type="button" onClick={handleEditInfoRestaurant}>Update</button>
